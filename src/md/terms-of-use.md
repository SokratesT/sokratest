## Terms of Use for the Sokrates^t^ Educational Platform

**Effective Date:** 17 April 2025

### 1. Introduction and Your Agreement

Welcome to Sokrates^t^ (the "Platform"). This educational platform is provided by Rhine-Waal University, located at Friedrich-Heinrich-Allee 25, 47475 Kamp-Lintfort, Germany ("Rhine-Waal University", "We", "Us", "Our"). These Terms of Use ("Terms") explain the rules for using Sokrates^t^.

Sokrates^t^ is part of an ongoing research project and is currently offered free of charge to eligible students during its testing phase.

**Your Agreement:** By creating an account and checking the box to accept these Terms during registration, or by using the Sokrates^t^ platform, you confirm that you have read, understood, and agree to follow these Terms. You also agree to our **Sokrates^t^ Privacy Policy**, which explains how we handle your data and is a part of this agreement. If you do not agree with these Terms or the Privacy Policy, you should not use the Platform.

### 2. Who Can Use Sokrates^t^ (Eligibility)

*   **University Courses:** Sokrates^t^ is currently available only to students enrolled in specific courses at Rhine-Waal University who have been invited by their instructor. Use is meant for activities related to these courses.
...
*   **Age:** You must be at least 18 years old to use Sokrates^t^. By agreeing to these Terms, you confirm you are 18 or older.
...
### 3. What Sokrates^t^ Offers

Sokrates^t^ allows you to chat with an Artificial Intelligence (AI) to help you learn. The AI uses materials uploaded by your instructor (like documents and presentations) to try and give relevant answers. Using Sokrates^t^ should help you learn and also helps us research and improve educational AI tools.

### 4. Important Disclaimer: AI Can Make Mistakes (Hallucinations)

*   **Be Aware:** The AI in Sokrates^t^, like many AI systems, can sometimes provide information that is incorrect, incomplete, misleading, or entirely made up. These errors are sometimes called "hallucinations."
...
### 5. How You Should Use Sokrates^t^ (Permitted Use)

Please use Sokrates^t^ only for its intended educational purposes:
...
### 6. What You Cannot Do on Sokrates^t^ (Prohibited Conduct)

To keep Sokrates^t^ safe and functional, you agree **not** to do any of the following:
...
*   **The Platform:** Rhine-Waal University owns the Sokrates^t^ platform itself (the software, design, etc.). These Terms give you permission to use it, but not ownership.
...
*   **Your Questions (Input):** You own the questions you type into the chat. However, you give us permission to use your questions to operate and improve Sokrates^t^ and for our research (your data will be anonymised if used in publications, as stated in the Privacy Policy).
...
*   **Your Feedback:** If you give us feedback about Sokrates^t^, thank you! We can use your feedback freely to improve the platform or for research, without paying you or giving you credit. In turn, you can use Sokrates^t^ completely free of charge - win-win!

### 8. Service Limitations and Disclaimers ("As Is")

Sokrates^t^ is a work in progress, especially during this testing phase. We provide it **"as is"** and **"as available"**.

*   **No Guarantees:** We don't promise that Sokrates^t^ will always meet your needs, be available without interruption, or be completely free of errors or bugs.
...
To the maximum extent permitted by German law, Rhine-Waal University or the Sokrates^t^ project team (including its staff and partners) will not be legally responsible for any indirect damages or losses (like loss of data, profit, or goodwill) resulting from your use or inability to use Sokrates^t^. This includes damages caused by:
...
*   **By Us:** We can suspend or stop your access to Sokrates^t^ at any time, for reasons such as:
    *   You violate these Terms or the Privacy Policy.
    *   Your course ends, or you leave the university.
    *   The Sokrates^t^ project ends.
    *   Your account is inactive for a long time.
    *   Your actions risk the platform's security or harm others.
*   **By You:** You can ask to stop using Sokrates^t^ and delete your account by contacting your course instructor. They will inform the project team. (There isn't a feature for this in the platform yet).
*   **What Happens:** If your access ends, you won't be able to use Sokrates^t^ anymore. Your data will be handled as described in our Privacy Policy. Some sections of these Terms (like 4, 7, 8, 9, 11, 12) will still apply even after termination.
...
We may update these Terms sometimes. If we make important changes, we will notify you on the platform (like with a pop-up when you log in) before the changes take effect. The notice will explain the changes. To continue using Sokrates^t^ after the changes, you will need to agree to the new Terms. If you don't agree, you should stop using the platform and ask to have your account deleted (see Section 10).

### 13. How to Contact Us

*   **For help using Sokrates^t^ or account issues:** Contact your **course instructor** first.
...
*   **For privacy questions:** See the contact details in the Sokrates^t^ Privacy Policy.

### 14. Final Points

These Terms and the Privacy Policy are the complete agreement between you and Rhine-Waal University about using Sokrates^t^. If any part of these Terms is found to be invalid, the rest still applies. If we don't enforce a right under these Terms immediately, it doesn't mean we waive that right for the future.