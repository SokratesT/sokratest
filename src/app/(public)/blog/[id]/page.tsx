import { TipTapReader } from "@/app/app/posts/_components/tiptap-reader";
...
import { MoveRight, PhoneCall, UserIcon } from "lucide-react";
    ...
    <div>
        ...
        <div className="flex flex-col items-center justify-center gap-8 py-10 lg:py-20">
          <div>
            <Button variant="secondary" size="sm" className="gap-4">
              <UserIcon className="h-4 w-4" /> {author.name}
            </Button>
          </div>
      ...
      <Card className="mx-auto max-w-full lg:max-w-[60%]">
        <CardContent className="p-4">
          <TipTapReader content={queryPost.html} />
        </CardContent>
      </Card>
    </div>
  );
